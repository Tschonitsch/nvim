...
vim.api.nvim_set_hl(0, "Visual", { bg = "#733426", fg = "#561f12" })
vim.api.nvim_set_hl(0, "VisualNOS", { bg = "#322825" })

vim.api.nvim_set_hl(0, "Search", { bg = "#ffb4a4", fg = "#561f12" })
vim.api.nvim_set_hl(0, "IncSearch", { bg = "#dbc58c", fg = "#1a110f" })
vim.api.nvim_set_hl(0, "CurSearch", { bg = "#ffb4a4", fg = "#561f12" })
...
vim.api.nvim_set_hl(0, "PmenuSel", { fg = "#561f12", bg = "#ffb4a4" })
...
vim.api.nvim_set_hl(0, "TabLineSel", { fg = "#561f12", bg = "#ffb4a4" })
...
vim.api.nvim_set_hl(0, "DiffText", { bg = "#733426", fg = "#561f12" })
